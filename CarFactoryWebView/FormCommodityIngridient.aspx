<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormCommodityIngridient.aspx.cs" Inherits="CarFactoryWebView.FormCommodityIngridient" %>
...
<body>
    ...
    <div>
        ...
        Компонент&nbsp;&nbsp;
        <asp:DropDownList ID="DropDownListIngridient" runat="server" Height="16px" Width="200px">
        </asp:DropDownList>
        <br />
        <br />
        Количество&nbsp;
