...
namespace CarFactoryWebView
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<DbContext, CarFactoryWebDbContext>();
            container.RegisterType<IConsumer, ConsumerServiceDB>();
            container.RegisterType<IIngridient, IngridientServiceDB>();
            container.RegisterType<IWorker, WorkerServiceDB>();
