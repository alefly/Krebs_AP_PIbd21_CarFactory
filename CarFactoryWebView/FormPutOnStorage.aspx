<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormPutOnStorage.aspx.cs" Inherits="CarFactoryWebView.FormPutOnStorage" %>
...
<body>
    ...
    <div>
        ...
        <br />
        Компонент&nbsp;&nbsp;
        <asp:DropDownList ID="DropDownListIngridient" runat="server" Height="17px" Width="194px">
        </asp:DropDownList>
        <br />
        <br />
        Количество&nbsp;
